...
import uit.tkorg.cspublicationcrawler.dto.PaperPaperDTO;
/**
...
public class PaperPaperMapper extends MapperDB {
    ...
    public int insertObj(PaperPaperDTO objDTO) throws Exception {
        try {
            ...
            sql.append("INSERT INTO cspublicationcrawler.Paper_Paper(idPaper,"
    ...
    public int isExisted(PaperPaperDTO objDTO) throws Exception {        
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM cspublicationcrawler.Paper_Paper");
    ...
    public int updateObj(PaperPaperDTO objDTO) throws Exception {
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE cspublicationcrawler.Paper_Paper");                                          
