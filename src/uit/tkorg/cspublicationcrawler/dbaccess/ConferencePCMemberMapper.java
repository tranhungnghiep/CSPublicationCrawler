...
import uit.tkorg.cspublicationcrawler.dto.ConferencePCMemberDTO;
...
public class ConferencePCMemberMapper extends MapperDB {
    ...
    public int insertObj(ConferencePCMemberDTO objDTO) throws Exception {
        try {
            ...
            sql.append("INSERT INTO cspublicationcrawler.Conference_PCMember(idConference,"
                    + " idPCMember, year)");                                          
            sql.append(" VALUES(?,?, ?)");
    ...
    public int isExisted(ConferencePCMemberDTO objDTO) throws Exception {        
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(" SELECT * FROM cspublicationcrawler.Conference_PCMember");
    ...
    public int updateObj(ConferencePCMemberDTO objDTO) throws Exception {
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE cspublicationcrawler.Conference_PCMember");                                          
            sql.append(" SET year=?");                    
            sql.append(" WHERE idConference=? AND idPCMember=?");
